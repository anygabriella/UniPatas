    ...
    public Usuario read(int id) throws Exception {
        ...
        while(arq.getFilePointer() < arq.length()) {
            ...
            if(lapide == 0){
                ...
                } else arq.skipBytes(tam - 4); //se não for o id, pula o resto do registro (já leu 4 bytes do id)
            } else arq.skipBytes(tam); //se lapide for 1, pula
        }

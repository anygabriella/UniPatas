...
public class Usuario{
    ...
    public Usuario(String nome, String cpf, String email, String senhaXOR, String telefone, String cidade, String estado){
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
    ...
    public Usuario(int id,String nome, String cpf, String email, String senhaXOR, String telefone, String cidade, String estado){
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
    ...
    public void setSenha(String senhaXOR) {this.senha = senhaXOR;}
    public void setTelefone(String telefone) {this.telefone = telefone;}
    public void setCidade(String cidade) {this.cidade = cidade;}
    public void setEstado(String estado) {this.estado = estado;}

    public String mostrar(){
        return "ID: " + id + " | Nome: " + nome + " | CPF: " + cpf + " | Email: " + email + " | Telefone: " + telefone + " | Cidade: " + cidade + " | Estado: " + estado;
    }

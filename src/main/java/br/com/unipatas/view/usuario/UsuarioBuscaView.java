...
public class UsuarioBuscaView {
    ...
    public VBox getConteudo() {
        ...
        txtIdBusca.setPromptText("Nome do Usuário");
        Button btnBuscar = new Button("Buscar");
        hbBusca.getChildren().addAll(new Label("Nome do Usuário:"), txtIdBusca, btnBuscar);
        ...
        gridResultados.add(lblResultadoNome, 1, 0);
        gridResultados.add(new Label("CPF:"), 0, 1);
        gridResultados.add(lblResultadoCpf, 1, 1);
        gridResultados.add(new Label("Email:"), 0, 2);
        gridResultados.add(lblResultadoEmail, 1, 2);
        gridResultados.add(new Label("Cidade:"), 0, 3);
        gridResultados.add(lblResultadoCidade, 1, 3);
